...
public protocol NewFeaturSubViewItemable {
...
public extension NewFeaturSubViewItemable {
    func zymeDidEnterForeground() {}
    func zymeDidEnterBackGround() {}
    func setCompleteBlock(block: @escaping ()->Void) {}
}

public class ZymeNewFeatureViewController: UIViewController {
    ...
    public convenience init(_ imagesNames: [String]) {
        self.init()
        self.dataSourceType = .imageName
        self.imagesNames = imagesNames
    }
    
    public convenience init<T: NewFeaturSubViewItemable>(_ customContainerViews: [T]){
        self.init()
