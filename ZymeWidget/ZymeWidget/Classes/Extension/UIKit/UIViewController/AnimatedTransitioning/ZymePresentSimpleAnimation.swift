...
//
//  zymePresentRightToLeftAnimation.swift
//  zyme
//
...
class ZymePresentSimpleAnimation: NSObject, ZymeTransitioningAnimatorable {
    
    enum ZymeTranslationStyle {
        case rightToLeft, leftToRight, bottomToTop, show
    }
    
    var isPresent: Bool
    var translationStyle: ZymeTranslationStyle
    init(_ translationStyle: ZymeTranslationStyle) {
        self.isPresent = true
