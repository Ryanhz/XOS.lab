//
//  ZymeInteractiveTransition.swift
//  zyme
//
...
protocol ZymePushPopAnimatedTransitioningable: UIViewControllerAnimatedTransitioning{
    var isPop: Bool {get set}
    var delegate: UINavigationControllerDelegate? {get set}
    var navigationController: UINavigationController? {get set}
}

class ZymeInteractiveTransition: UIPercentDrivenInteractiveTransition {
...
extension ZymeInteractiveTransition: UINavigationControllerDelegate {
    ...
    func navigationController(_ navigationController: UINavigationController, animationControllerFor operation: UINavigationController.Operation, from fromVC: UIViewController, to toVC: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        ...
        case .pop:
            ...
            switch animatedType {
            case .backScale:
                return ZymePushPopBackAnimatedTransitioning(isPush: false)
            case .targetViewScale:
        ...
        case .push:
            switch animatedType {
            case .backScale:
                return ZymePushPopBackAnimatedTransitioning(isPush: true)
            case .targetViewScale:
    ...
    func getTargetViewScaleAnimatedTransitioning( isPop: Bool, from fromVC: UIViewController, to toVC: UIViewController) -> ZymePushPopScaleAnimatedTransitioning? {
        if isPop {
            guard let fromP = fromVC as? ZymePushPopScaleAnimatedTransitioningable,
                let toP = toVC as? ZymePushPopScaleAnimatedTransitioningable,
        ...
        return ZymePushPopScaleAnimatedTransitioning(isPush: !isPop)
    }
}
