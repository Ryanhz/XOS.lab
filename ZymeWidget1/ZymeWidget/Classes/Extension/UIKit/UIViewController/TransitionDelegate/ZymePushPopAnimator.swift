...
class ZymePushPopAnimator: NSObject  {

    var isPush : Bool = true
}

extension ZymePushPopAnimator: UINavigationControllerDelegate{
...
extension ZymePushPopAnimator: UIViewControllerAnimatedTransitioning{
