...
extension HzyNamespaceWrapper where T == String {
    ...
    ///富文本的高度
    public func heightWithStringAttributes(_ attributes : [NSAttributedStringKey : Any], fixedWidth : CGFloat) -> CGFloat {
...
//        wrappedValue.bo
    ...
    /// 富文本的宽度
    public func widthWithStringAttributes(_ attributes : [NSAttributedStringKey : Any]) -> CGFloat {
...
//    @discardableResult
//    func getMd5MessageDiges() -> String{
//
//        let cStr = wrappedValue.cString(using: .utf8)
//        let strLen = CUnsignedInt(wrappedValue.lengthOfBytes(using: .utf8))
